        ...
        @LoginName = :LoginName`;
            ...
            if (record) {
                const count: Dashboard<any> = {
                    ...
                    InProgressJobsCount: record.InProgressJobsCount,
                    VoidJobsCount: record.VoidJobsCount,
                    DuplicateJobsCount: record.DuplicateJobsCount,
                    DownloadedJobsCount: record.DownloadedJobsCount,
                }
                return count;
            } else {
